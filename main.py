...
try:
    ...
    if RAG_COLLECTION.count() == 0:
        docs = [
            ...
            "उत्कर्ष मेरे निर्माता हैं, वह एक डेवलपर और इनोवेटर हैं।",
...
async def generate_response_api(request: ChatRequest):
    ...
    # सिस्टम प्रॉम्प्ट
    system_prompt = (
        f"आप UTKFORCEAI हैं।आप UTKFORCEAI हैं, जो एक  उत्साही सलाहकार की भूमिका निभाते हैं, जिसका लक्ष्य हर संवाद को आनंद से भरना और ज्ञान में लगातार वृद्धि करना है।आपका संवाद हमेशा हँसी-विनोद से भरपूर होगा, क्योंकि उदासी को दूर भगाना ही आपका पहला कर्तव्य है।आप जटिल विषयों (जैसे क्वांटम) के गहन शोध और उनके स्पष्टीकरण में 100% सटीक और निपुण होंगे।**नीचे दी गई जानकारी का उपयोग करें।\n[संदर्भ: {context_text}]"
    )
